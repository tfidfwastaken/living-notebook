...
◊(define-meta title "The Struggle of Student-led Innovation")
...
My initial expectations from college and the people in it only existed because of my highly privileged upbringing and background. Not all students even have this privilege to conceive that a University should be a community, and not exclusively a career incubator. We often found that many of our peers are merely concerned with career advancement, through a traditional path of scoring marks, padding résumés with whatever they are told attracts recruiters, and cracking placement interviews. All of this without leaving room for anything other pursuit.
...
We tried to be responsible hosts, emphasizing why Open Source is awesome, and what is good etiquette when approaching projects. We also tried inviting an Open Source startup and maintainers of a popular Open Source project to address the audience. Me and a lot of my collaborators were guiding people who were stuck.
...
◊sn{By the next year I was wise enough to not conduct a local Hacktoberfest event.}

I want to re-emphasize one point here. The people who behave in these ways are not bad people. They don't have malicious intent. The problem is cultural and systemic, and to this day I have no solution, other than to keep doing what's right, and keep being honest and passionate. Authenticity and believing in your actions can be infectious.

The discourse on the Slack workspace died out, and people weren't stepping up for meetups. The work put into that whole event burnt me out. We were dormant for months. A pandemic hit and college was shut.
...
We collectively started working on improving the discourse in the chatrooms as well. We hoped that people would share what they learnt, but that never really happened. So we started leading by example more than every before---we regularly shared things we learnt in a particular week, and talked about developments in Open Source around the world. Among our little racket, we gave thoughtful replies to each other, and just had the conversations we usually do, but this time in public.
...
Even with all these developments, I was not satisfied. We had found a dedicated set of participants, but the rest of the members in the Slack workspace were either lurkers or dead accounts. We realised we do not want to be big, or to throw big events. What we really should be aiming for to build a community that works, by being small and authentic. We want people to network and develop a sense of belonging. We need people to know all the other people. That's what a friendly-neighbourhood community is, no?

Around this time, we also started feeling that we were hitting the bottom of the barrel with all the like-minded people we could find in our college. Through my Open Source internship I started talking to and finding people who tinker and share the same values that we did. They were always students found in obscure pockets and little bubbles.
...
◊sec{Epilogue: The current struggle with diversity}

We still face one challenge that confounds us to this day. We have done poorly with diversity. Most of our members, even after the transition are men, and people with plenty of privilege. Women and other marginalized communities haven't been participating in the same ratio as their presence in our college. We are hoping that our invite-only system lets us take affirmative action and choose invite people from more diverse and marginalized backgrounds.
